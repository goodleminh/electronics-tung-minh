...
import { actFetchCategories, type ICategory } from "../../redux/features/category/categorySlice";
  ...
  const filtered = useMemo(() => {
    ...
    switch (sortParam) {
      ...
      case "newest":
        ...
        break;
      case "bestseller": {
        const getSold = (x: IProduct) => Number((x as any).sold ?? (x as any).sold_count ?? 0);
      ...
      <main className="py-8">
        <div className="max-w-7xl mx-auto px-4">
          ...
          <div className="flex items-end justify-between mb-6">
            <h1 className="text-2xl md:text-3xl font-semibold">Tìm kiếm sản phẩm</h1>
          ...
          <div className="grid grid-cols-1 md:grid-cols-12 gap-8">
            ...
            >
              <form onSubmit={onSubmit} className="space-y-4">
                <div>
                  <label className="block text-sm mb-1 text-gray-700">Từ khóa</label>
                  <input
                    value={q}
                ...
                <div>
                  <label className="block text-sm mb-1 text-gray-700">Khoảng giá (VND)</label>
            ...
            <section className="md:col-span-9">
              ...
              {!loading && filtered.length === 0 && !error && (
                <div className="text-center text-gray-500">Không có sản phẩm phù hợp.</div>
              )}
