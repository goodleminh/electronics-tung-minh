      ...
      <main>
        ...
        <section className="bg-[#f3f3f3]">
          <div className="max-w-7xl mx-auto px-4 py-12 text-center">
            <h1 className="text-3xl md:text-4xl font-semibold">Giới thiệu về Electronics</h1>
            <p className="text-gray-600 mt-3 max-w-3xl mx-auto">
              Electronics là nền tảng mua sắm điện tử và gia dụng hiện đại, mang đến sản phẩm chính hãng,
              giá tốt cùng trải nghiệm mua sắm nhanh chóng, an toàn và tiện lợi.
            </p>
          </div>
        </section>
        ...
        <section className="py-12 bg-gray-50">
          <div className="max-w-7xl mx-auto px-4 grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
            <div>
              <h2 className="text-2xl md:text-3xl font-semibold mb-4">Sứ mệnh & Giá trị</h2>
              <p className="text-gray-700 mb-3">
                Chúng tôi hướng tới việc xây dựng hệ sinh thái mua sắm điện tử đáng tin cậy, nơi khách hàng
                dễ dàng tìm thấy sản phẩm chất lượng với mức giá hợp lý và dịch vụ hậu mãi chu đáo.
              </p>
              <ul className="space-y-2 text-gray-700 list-disc pl-5">
                <li>Chọn lọc nhà bán uy tín, sản phẩm rõ nguồn gốc.</li>
                <li>Giao diện thân thiện, tối ưu trải nghiệm trên mọi thiết bị.</li>
            ...
            <div className="grid grid-cols-2 gap-4">
              <div className="p-6 bg-white border border-gray-200 text-center">
                <div className="text-3xl text-[#8b2e0f] mb-2"><ShopOutlined /></div>
                <div className="text-2xl font-bold">+5,000</div>
                <div className="text-gray-600">Sản phẩm</div>
              </div>
              <div className="p-6 bg-white border border-gray-200 text-center">
                <div className="text-3xl text-[#8b2e0f] mb-2"><TrophyOutlined /></div>
        ...
        <section className="py-12">
          <div className="max-w-7xl mx-auto px-4">
            <div className="text-center mb-8">
              <h2 className="text-[30px] inline-block border-b-2 border-[brown]">Vì sao chọn Electronics?</h2>
            </div>
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              {[{
                ...
                <div key={it.title} className="p-6 border border-gray-200 bg-white text-center transition-all duration-300 hover:-translate-y-1 hover:shadow-2xl">
        ...
        <section id="newsletter" className="py-12 bg-gray-100">
          <div className="max-w-7xl mx-auto px-4 text-center">
            <div className="mb-6">
              <h2 className="text-[25px] inline-block border-b-2 border-[brown]">Đăng ký nhận bản tin</h2>
              <p className="text-gray-600 mt-2">Nhận khuyến mãi và sản phẩm mới mỗi tuần</p>
            </div>
            <form onSubmit={(e) => e.preventDefault()} className="w-full max-w-md mx-auto flex flex-col sm:flex-row items-stretch gap-3">
              ...
              />
              <button type="submit" className="bg-[#8b2e0f] text-white px-6 py-3 hover:bg-gray-800 transition cursor-pointer">Đăng ký</button>
            </form>
