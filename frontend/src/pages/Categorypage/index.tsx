...
const Categorypage: React.FC = () => {
  ...
  const { categories, loading, error } = useSelector((s: RootState) => s.category);
      ...
      <main className="py-8">
        <div className="max-w-7xl mx-auto px-4">
          <div className="flex items-end justify-between mb-6">
            <h1 className="text-2xl md:text-3xl font-semibold">Danh mục sản phẩm</h1>
            <span className="text-sm text-gray-500">{categories.length} danh mục</span>
          </div>

          {loading && <div className="text-center py-8">Đang tải danh mục...</div>}
          {error && (
