    ...
    <>
      <div className="grid grid-cols-12 gap-10 max-w-7xl mx-auto px-12 mt-12 mb-12">
        ...
        <div className="col-span-12 sm:col-span-12 md:col-span-6 lg:col-span-6 text-start content-center">
          {/* product name */}
          <h3 className="text-gray-800 mb-4 text-2xl font-medium">
            {productDetail.name}
          </h3>
          {/* product price */}
          <div className="mb-4">
          ...
          <div className="flex gap-8">
            <h2
              ...
              onClick={showModal1}
            >
              Giao hàng và trả lại
            </h2>
            <Modal
              closable={{ "aria-label": "Custom Close Button" }}
              open={isOpenDelivery}
              onCancel={() => setIsOpenDelivery(false)}
              footer={null}
              centered
            >
              {/* Modal content */}
              <div className="py-5">
                {/* Delivery */}
                <h2 className="text-2xl font-medium mb-2">Giao hàng</h2>
                <p className="mb-2">
                  Tất cả các đơn hàng được vận chuyển bằng UPS Express.
                </p>
                <p className="mb-2">
                  Luôn miễn phí vận chuyển cho các đơn hàng trên 250 đô la Mỹ.
                </p>
                <p className="mb-4">
                  Tất cả các đơn hàng đều được vận chuyển kèm theo mã theo dõi
                  của UPS.
                </p>
                {/* Return */}
                <h2 className="text-2xl font-medium mb-2">Returns</h2>
                <p className="mb-2">
                  Trả hàng Các mặt hàng được trả lại trong vòng 14 ngày kể từ
                  ngày giao hàng ban đầu và còn nguyên vẹn như mới sẽ được hoàn
                  tiền đầy đủ hoặc được ghi có vào tài khoản cửa hàng.
                </p>
                <p className="mb-2">
                  Số tiền hoàn lại sẽ được trừ vào hình thức thanh toán ban đầu
                  đã sử dụng để mua hàng.
                </p>
                <p className="mb-2">
                  Khách hàng chịu trách nhiệm chi trả phí vận chuyển khi trả
                  hàng và phí vận chuyển/xử lý của đơn hàng ban đầu sẽ không
                  được hoàn lại.
                </p>
                <p className="mb-4">
                  Tất cả các mặt hàng giảm giá đều là giao dịch mua cuối cùng.
                </p>
                <h2 className="text-2xl font-medium mb-2">Help</h2>
                <p className="mb-2">
                  Hỗ trợ Hãy liên hệ với chúng tôi nếu bạn có bất kỳ câu hỏi
                  và/hoặc thắc mắc nào khác.
                </p>
                <p className="mb-2">
            ...
            <Modal
              closable={{ "aria-label": "Custom Close Button" }}
              open={isOpenQuestion}
              onCancel={() => setIsOpenQuestion(false)}
              footer={null}
              centered
            >
              {/* Modal content */}
      ...
      <div className="max-w-7xl mx-auto mt-10 px-12">
        ...
        <div className="text-gray-800 leading-relaxed mb-10">
          {activeTab === "description" && (
            <div>
              <h2 className="text-lg font-bold mb-4">Chi tiết hơn</h2>
          ...
          {activeTab === "reviews" && (
            <div>
              <h2 className="text-lg font-bold mb-4">Đánh giá (0)</h2>
              <p>
